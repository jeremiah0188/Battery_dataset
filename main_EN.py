...
<style>
    ...
    /* ---- 核心修复：直接命中包裹导航栏的 BorderWrapper 节点 ---- */
    div[data-testid="stVerticalBlockBorderWrapper"]:has(.nav-shell),
    div[data-testid="stVerticalBlockBorderWrapper"]:has([data-testid="stHorizontalBlock"] .nav-shell) {
        background: transparent !important;
        background-color: transparent !important;
        border: none !important;
        backdrop-filter: none !important;
